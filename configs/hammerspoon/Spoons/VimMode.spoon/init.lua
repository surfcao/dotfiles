...
function VimMode:bindModeKeys()
  ...
  -- by guofeng
  self.mode:bind({'ctrl'}, 'w', compose(operators.delete(self), motions.backWord(self)))
  self.mode:bind({'ctrl'}, 'u', compose(operators.delete(self), motions.beginningOfLine(self)))
  ---------- commands
